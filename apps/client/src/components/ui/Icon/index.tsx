...
export const LocationIcon = ({ title, ...props }: IconProps) => (
  <svg
...
export const CloseIcon = ({ title, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const ArrowRightSolidIcon = ({ title, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 20 20"
    fill="currentColor"
...
export const UserCircleIcon = ({ title, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const DollarSignIcon = ({ title, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M17 5c0-1.657-2.239-3-5-3s-5 1.343-5 3 2.239 3 5 3 5 1.343 5 3-2.239 3-5 3-5-1.343-5-3"
    />
  </svg>
);
