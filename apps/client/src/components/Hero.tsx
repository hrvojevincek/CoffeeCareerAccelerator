...
function Hero() {
  return (
    <div className="h-screen flex items-center justify-center bg-no-repeat sm:bg-cover md:bg-cover bg-fixed bg-[url('https://media.timeout.com/images/105871441/image.jpg')] bg-gray-300 bg-blend-multiply">
