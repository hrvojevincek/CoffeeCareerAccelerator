        ...
        <ul className="space-y-2">
          ...
          <li>
            <Link
              ...
              <span className="flex-1 ml-3 text-left whitespace-nowrap">Edit Your CV</span>
            </Link>
          </li>
        </ul>
        <ul className="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
          <li>
            <Link
              ...
              <span className="flex-1 ml-3 text-left whitespace-nowrap">Edit Profile</span>
            </Link>
          </li>
          ...
          <li>
            <button
              ...
              className="flex items-center w-full p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
              <svg
                aria-hidden="true"
                className="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                fill="currentColor"
              ...
              <span className="ml-3">Logout {logout.isPending && '(Logging out...)'}</span>
            </button>
          </li>
        </ul>
        <Link to="/">
          <p className="mt-10 dark:text-white text-sm font-extralight ml-3">Back to Homepage</p>
        </Link>
      </div>
    </aside>
  );
